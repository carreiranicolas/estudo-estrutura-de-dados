...
int main(void) {
	...
	Assim, nós teremos as rotações que buscarão corrigir o fator de balanceamento (ou fb), que é a diferença entre a altura da subarvore à esquerda - a altura da subarvore à direita
